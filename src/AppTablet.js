...
const BlogPage = ({ setCurrentPage, theme, blogPosts, linkedinPosts }) => {
  return (
        ...
        >
          <div className="relative h-48 mb-4 rounded-lg overflow-hidden shadow-md">
            <img
              src={project.image}
              alt={project.title}
              className="w-full h-64 object-contain rounded-lg mb-8 shadow-lg" // Changed to h-64 and object-cover for zoomed effect
              onError={(e) => { e.target.onerror = null; e.target.src = "https://placehold.co/600x300/CCCCCC/000000?text=Image+Error"; }}
            />
    ...
    const AppTablet = () => {
      ...
      // const skills = [
      //   { name: 'Python', icon: <Code size={48} className="text-blue-500 mb-4"/>, description: 'Pandas, NumPy, Feature Engineering, Data Processing' },
      //   { name: 'SQL', icon: <Database size={48} className="text-green-500 mb-4"/>, description: 'Joins, CTEs, Window Functions, Analytics Queries' },
      //   { name: 'Power BI', icon: <BarChart size={48} className="text-indigo-500 mb-4"/>, description: 'Dashboard Design, DAX, KPI Modeling' },
      //   { name: 'Data Analytics', icon: <BarChart size={48} className="text-purple-500 mb-4" />, description: 'Data Cleaning, EDA, Business Insights' },
      //   { name: 'Excel', icon: <FileText size={48} className="text-emerald-500 mb-4"/>, description: 'Advanced Formulas, Pivot Tables, Forecasting' },
      //   { name: 'Machine Learning', icon: <Bot size={48} className="text-pink-500 mb-4"/>, description: 'Logistic Regression, Classification, Model Evaluation' },
      //   { name: 'BigQuery', icon: <Database size={48} className="text-purple-700 mb-4" />, description: 'Analytics Tables, SQL Modeling, Snapshots' },
      //   { name: 'Data Warehousing', icon: <Database size={48} className="text-indigo-700 mb-4"/>, description: 'ETL Concepts, Star Schema, Fact & Dimension Tables' },
      //   { name: 'Real-time Analytics', icon: <Zap size={48} className="text-red-500 mb-4" />, description: 'Automated Pipelines, Live Market Monitoring' },
      //   { name: 'n8n Automation', icon: <Zap size={48} className="text-orange-500 mb-4"/>, description: 'n8n Workflows, Scheduled Data Pipelines' },
      //   { name: 'APIs', icon: <Code size={48} className="text-cyan-500 mb-4"/>, description: 'REST APIs, JSON, Data Ingestion' },
      //   { name: 'Data Visualization', icon: <Layers size={48} className="text-orange-600 mb-4"/>, description: 'Insight Narratives, Business Dashboards' },
      // ];
const skills = [
  {
  ...
  {
    name: <center>Machine<br />Learning</center>,
  ...
  {
    name: <center>n8n<br />Automation</center>,
  ...
  {
    name: <center>Data<br />Visualization</center>,
    icon: <Layers size={48} className="text-orange-600 mb-4" />,
    description: (
      <center>
        Insight Narratives,<br />
        Business<br />
        Dashboards
      </center>
    ),
          ...
          case 'home':
            return (
              <>
                ...
                <HeroSection theme={theme}>
                  ...
                  <HeroContent>
                    <StyledCombinedHeroHeading theme={theme}>
                        ...
                        <span className="hero-title-text"><span className="hero-title-text">A Data Analyst Building Decision-Ready Insights from Real-World Data</span>
                        </span>
                    ...
                    <div className={`rounded-xl shadow-2xl p-8 border
                      ...
                      <div className="grid grid-cols-1 gap-12 items-center">
                          ...
                          <div className="flex justify-center space-x-6 text-3xl">
                            ...
                            <a href="mailto:rtejasiddhartha18@gmail.com" target="_blank" className="p-3 rounded-full bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors duration-200" aria-label="Mail">
                              ...
                              <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="px-6 py-3 rounded-full bg-purple-600 text-white font-semibold hover:bg-purple-700 transition-colors duration-200 flex items-center justify-center"
                              >
                                View Resume (PDF)
                              </a>
                        ...
                        <div className="order-2">
                          ...
                          <p className={`text-lg mb-4 ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'}`}>Data & BI Analyst | SQL • Python • Power BI | End-to-End Analytics</p>
                          <p className={`text-lg leading-relaxed mb-6 ${theme === 'dark' ? 'text-gray-200' : 'text-gray-700'}`}>
                            I am a Data Analyst experienced in building end-to-end analytics solutions across finance, customer analytics, healthcare, retail, and digital asset markets. I transform raw data into structured datasets, well-defined KPIs, and interactive dashboards that support business and operational decisions.</p>
                ...
                <section id="education-certifications" className={`py-14 px-8
                ...
                {/* Projects Section */}
                <section id="projects" className={`py-14 px-8
                  ${theme === 'dark' ? 'bg-gray-900' : 'bg-gray-100'}`}>
                  <div className="max-w-4xl mx-auto">
                ...
                <section id="skills" className={`py-14 px-8
                  ${theme === 'dark' ? 'bg-gray-800' : 'bg-white'}`}>
                  <div className="max-w-6xl mx-auto px-4">
                    ...
                    <div className="grid grid-cols-3 gap-8 justify-items-stretch">
                      {skills.map((skill, index) => (
                        <div
                          key={index}
                          className={`flex flex-col items-center justify-start p-6 rounded-xl shadow-lg transition-all duration-300 hover:scale-105 group h-full w-full
                            ${theme === 'dark'
                        ...
                        >
                          ...
                          <p className="text-center text-sm opacity-80 group-hover:opacity-100 transition-opacity duration-300">
                            {skill.description}
                          </p>
                        </div>
                      ))}
                ...
                <section id="contact" className={`py-14 px-8
                  ${theme === 'dark' ? 'bg-gray-900' : 'bg-gray-100'}`}>
            ...
            <header className={`relative py-4 px-8 flex items-center justify-between transition-colors duration-300
              ...
              <div className="container mx-auto px-4 flex justify-between items-center">
                ...
                <nav className="flex items-center space-x-6">
                  ...
                  <button onClick={() => scrollToSection('skills')} className="text-base font-semibold hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors duration-200">My Skills</button>
